...
const Sidebar = () => {
  ...
  return (
    <>
      {/* Mobile/Tablet Hamburger/Close Menu Button - Only visible on mobile and tablet */}
      ...
      {/* Mobile/Tablet Overlay - Only visible when menu is open on small screens */}
      {isMobileMenuOpen && (
        <div 
      ...
      {/* Sidebar */}
      <div className={`
        h-screen bg-sidebar text-white flex flex-col z-40 w-64
      ...
      `}>
        ...
        <div className="mt-8 flex-1">
          <div className="px-4">
            <div className="flex items-center px-4 py-3 rounded text-white mb-2 hover:bg-sidebar-light cursor-pointer">
        ...
        <div className="px-4 py-6 border-t border-gray-700">
          <div className="text-center">
            <div className="flex flex-col items-center mb-2">
              <img src={boxRocket} alt="Rocket Box" className="h-24 w-24 mb-2" />
