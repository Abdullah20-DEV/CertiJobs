  ...
  <div className="bg-[#F4F8FB] -ml-8">
    ...
    <div className="grid grid-cols-4 gap-6 p-6 pt-4 h-[14rem]">
      ...
      <div>
        ...
        <div className="bg-[#F2F2F2] py-2 w-[64.5rem] ml-[-2rem] pl-4 flex justify-center items-center lg:-mt-[2rem]">
  <p style={{ color: '#8C8C8C', fontSize: '0.75rem', textAlign: 'center', fontFamily: 'SF UI Text, sans-serif', fontWeight: 'normal', letterSpacing: '0.5em' }}>
